...
const Collection = () => {
  return (
    <div className='py-12 container grid grid-cols-2 gap-6 max-[500px]:gap-4 max-[990px]:grid-cols-1'>
        {
            data?.map(item => (
                <div key={item.id} className='h-[664px] border relative max-[500px]:max-h-[377px]'>
