  ...
  const productItems = data?.map((product) => (
    <div key={product.id} className={child}>
      <div className="h-[349px] max-[600px]:h-[203px] relative overflow-hidden product-image">
        ...
        <button className="cart-btn absolute w-[230px] max-[900px]:w-[200px] max-[600px]:w-[160px] max-[600px]:bottom-0 max-[900px]:left-0 left-4 bottom-[-46px] h-[46px] bg-black text-white font-medium rounded-lg duration-300">
          Add to cart
        </button>
      </div>
      <div className="pt-3">
